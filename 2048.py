        ...
        if key in self.commands:
            ...
            if changed:
                ...
                if Logics.get_current_state(self.matrix) == 'WON':
                    ...
                    self.grid_cells[2][0].configure(text="Made", bg=c.BACKGROUND_COLOR_CELL_EMPTY)
                    self.grid_cells[2][1].configure(text="By", bg=c.BACKGROUND_COLOR_CELL_EMPTY)
                    self.grid_cells[2][2].configure(text="Aadil", bg=c.BACKGROUND_COLOR_CELL_EMPTY)
                    self.grid_cells[2][3].configure(text="Ghani", bg=c.BACKGROUND_COLOR_CELL_EMPTY)
